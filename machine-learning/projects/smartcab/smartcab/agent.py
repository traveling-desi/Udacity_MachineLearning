...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.Q[self.prev_state] = dict()
        self.Q[self.prev_state]['forward'] = 0.04
        self.Q[self.prev_state]['left'] = 0.03
        self.Q[self.prev_state]['right'] = 0.02
        self.Q[self.prev_state][None] = 0.01
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.total_trials += 1
            #self.epsilon = 1.0/math.exp(0.01 * self.total_trials)
            self.epsilon = 1.0/math.exp(0.05 * self.total_trials)
        return None
    ...
    def build_state(self):
        ...
        state = (waypoint, in_light, in_oncoming, in_left)
        self.state = state
    ...
    def get_maxQ(self, state):
        ...
        maxQ = 0.0
        for action_t in self.Q[state]:
             if (self.Q[state][action_t] > maxQ):
                max_action = self.Q[state][action_t]
        return maxQ 
	...
	# Needed this for a wild expriment.	
	if self.alpha:
...
def run():
    ...
    sim = Simulator(env, log_metrics=True, display=False, update_delay = 0.01)
